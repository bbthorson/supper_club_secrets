# Jasper — Book 1 Interiority

## Opening state

Two years into the friend group. 311 call center shifts that don't matter to him. Chelsea apartment that's "surprisingly nice" — a fact he protects from scrutiny because explaining it would mean explaining the trust fund and the family he's running from. The chaos persona is fully constructed and load-bearing. He believes in it as identity. He hasn't yet been forced to ask whether it's serving him.

Of all six core characters, Jasper has the most active arc in Book 1 — he creates the crisis (Brenda call) and resolves it (finds Hank). His interior journey is from "chaos as performance" to "chaos as choice." The book doesn't ask him to abandon the chaos; it asks him to know what it's for.
...
Avoid:
- Hinting at the old money in Book 1. The Chelsea apartment is the ONLY clue and should remain unexplained.
- Having him stay quiet for long stretches. The reversal works because it's unusual.
- The chaos as undirected. Even in performance mode, Jasper is selecting his targets and his connections — he's not random. Random would be exhausting; selected is endearing.
