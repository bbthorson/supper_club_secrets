...
|----|------|----------|--------------|------|--------|------|--------|--------|--------|
| 1 | Sun Oct 4 (am→pm) | McGolrick Park → Emma's apt | Opening Image / Theme Stated. Empty stall, Dorothy's bottle, cooking with the sauce. | **private**. Curious, then quietly alarmed. Western PA flickers when she gets stuck on the empty stall. | | | | | |
| 2 | Sun Oct 4 (evening) | Emma's apt | Setup. Friends arrive. Soup with the sauce. Disappearance becomes personal. | **public → private**. Hostess persona softening as the soup lands. | private. Late from work. Tasting the soup, dry validation. | public. Tech-snob about wine. Initial dismissiveness. | private (quiet). Defers to Olivia. Notices a detail no one else does. | public. Hostess overdrive — drawing everyone in. Calibrating reactions. | public. Performative chaos. First to arrive (daylight savings excuse). |
| 3 | Sun Oct 4 (evening) | Emma's apt | Catalyst. Marcus text: "like a man running from something." | private. Story-teller mode — tells the Hank/Dorothy story with the bottle in hand. | private. Just arrived. Tasting, confirming, gently puncturing speculation. | private. Skeptical but listening. | private (still quiet). | public. Texts Marcus mid-conversation. Gets the confirmation. | public. Pushing toward investigation. Energy building. |
...
|----|----------------|----------|-------|
| 1 | Dorothy | public (warm) | Gives Emma the bottle. "Just in case." |
