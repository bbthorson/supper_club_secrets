...
## B-plot: Emma's financial precarity

**Thread:** Emma's financial vulnerability and the shame beneath her proud exit from Bistro Lavande. Her private income source (the opaque secret) sits beneath this but is **never named on the page** — its reveal is deferred to a later book. Pike's retaliation targets her *visible* livelihood: an economic squeeze.
...
**Resolution applied 2026-05-23:** Option (b) — text reconciliation morning of Ch25. Adds the new texture "fear didn't end when the threat did" — extends sympathy to other targets of the intimidation campaign, which sets up the broader theme of Pike's reach without retraumatizing Emma.
...
**Action needed:** Carry forward — Brenda returns in Book 6 per series_plan.md. Acceptable as is, but optionally add a line in Ch25 where Jasper says he hasn't talked to her ("she's not returning my calls"). Sets up Book 6 tension cleanly.
...
| Dorothy never warmed back up | **resolved** | Ch25 morning text reconciliation. |
