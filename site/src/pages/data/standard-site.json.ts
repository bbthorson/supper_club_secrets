...
export const GET: APIRoute = async ({ site: origin }) => {
  ...
  if (!isVerifiable()) unresolved.push('no did / publicationRkey in src/lib/standard-site.ts');
  ...
  return new Response(
    JSON.stringify({ ready: unresolved.length === 0, unresolved, publication, documents }, null, 2),
